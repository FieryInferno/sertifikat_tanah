...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="<?= base_url(); ?>assets/css/templatemo-host-cloud.css">
  ...
  <body>
    ...
    <header class="">
      <nav class="navbar navbar-expand-lg">
        <div class="container">
          <a class="navbar-brand" href="<?= base_url(); ?>"><h2>SIMPEL BPN</h2></a>
          ...
          <div class="functional-buttons">
            <ul>
              ...
              <li><a href="<?= base_url(); ?>daftar.html">Sign Up</a></li>
            </ul>
          </div>
        </div>
      </nav>
